...
// Representa uma partícula física com as suas propriedades fundamentais
pub struct Particula{
    ...
    pub massa: f64,      // m — massa em quilogramas (kg)
    pub forca: f64,      // F — força em Newtons (N = kg·m/s²)
}


impl Cinematica for Particula{
